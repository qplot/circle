...
<div id="containercir">
    ...
    <?php foreach ($courses as $course): ?> <!-- displays circle for each instructor from array -->
      ...
      <div class="fieldcir">
        <div class="advisor-thumbhover"><a class="various" href="#"><img src="<?=$path;?><?=$instructor['pic_url'];?>" border="0" /></a></div>
        <div class="namehover"><?=$instructor['name'];?></div> <!-- displays instructor name -->
        <div class="titlehover"><?=$course['title'];?></div> <!-- displays course name -->
      </div>
