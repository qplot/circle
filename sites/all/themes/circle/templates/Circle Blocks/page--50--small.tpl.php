    ...
    <div id="content" class="column"><div class="section">
      ...
      <?php if ($title): ?>
        <h1 class="title" id="page-title">
          <?php print "15px smaller on each side"; ?>
        </h1>
      <?php endif; ?>
...
<div id="containercir">
    ...
    <?php foreach ($courses as $course): ?> <!-- displays circle for each instructor from array -->
      ...
      <div class="fieldcir">
        <div class="advisor-thumbsmall"><a class="various" href="#"><img src="<?=$path;?>/images/<?=$instructor['pic_url'];?>" border="0" /></a></div>
        <div class="namesmall"><?=$instructor['name'];?></div> <!-- displays instructor name -->
        <div class="titlesmall"><?=$course['title'];?></div> <!-- displays course name -->
      </div>
