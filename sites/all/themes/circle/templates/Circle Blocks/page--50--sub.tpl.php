    ...
    <div id="content" class="column"><div class="section">
      ...
      <?php if ($title): ?>
        <h1 class="title" id="page-title">
          <?php print "Sub Circles (Under Construction)" ?>
        </h1>
      <?php endif; ?>
...
<div id="container">
  ...
  <?php foreach ($courses as $course): ?>
    <?php $class = &$course['instructors'][0]['class']; $instructor = &$course['instructors'][0]; if ($class == 'subins'): ?>
      <div class="fieldc">
        <div class="advisor-thumb"><a class="various" href="#"><img src="<?=$path;?>/images/<?=$instructor['pic_url'];?>" border="0" /></a></div>
