...
<div id="page-wrapper"><div id="page">
  ...
  <div id="header" class="<?php print $secondary_menu ? 'with-secondary-menu': 'without-secondary-menu'; ?>"><div class="section clearfix">
   ...
   <!--  <?php if ($logo): ?>
    ...
    <?php endif; ?> -->
    <div id="advising"><a href="<?php print $front_page; ?>"><?php print $sitename?></a></div>
    ...
    <div id="header-links">
        <?php
          $block = module_invoke('menu', 'block_view', 'menu-header-menu');
  ...
  <div id="main-wrapper" class="clearfix"><div id="main" class="clearfix">
   ...
   <!--  <?php if ($page['sidebar_first']): ?>
    ...
    <div id="front-content" class="column"><div class="section">
      <?php if ($page['highlighted']): ?><div id="highlighted"><?php print render($page['highlighted']); ?></div><?php endif; ?>
      <a id="main-content"></a>
      <?php print render($title_prefix); ?>
      <?php if ($title): ?>
        <h1 class="title" id="front-title">
          <?php print 'My Advising Network';//$title; ?>
        </h1>
      <?php endif; ?>
